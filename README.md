...
4. [Итоговое задание №4](/data/final_task_4.md) модуля _«Введение в Linux и bash»._
...
7. [Итоговое задание №7](/data/final_task_7.md) модуля _«Программирование на Scala»._
8. [Итоговый проект](/data/final_project_1.md) курса.
